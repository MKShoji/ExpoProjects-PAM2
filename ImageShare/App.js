...
const TextoInstrucao = styled.text`
  color: #888;
  font-size: 18;
  marginHorizontal: 15;
`;
...
export default function App() {
  ...
  return (
    <View style={styles.container}> 
      ...
      <TextoInstrucao>To share a photo from your phone with a friend, just press the button below!</TextoInstrucao>
      <TouchableOpacity onPress={openImagePickerAsync} style={styles.button}>
        <TextoBtn> Pick a photo </TextoBtn>
      </TouchableOpacity>
    </View>
  );
}
